      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 relative z-10">
        <div className="space-y-2">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-white/20 px-3 py-1 text-xs font-bold backdrop-blur-sm">
            ...
            <span>Limited Time Beauty Drop</span>
          </div>

          <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight">
            Up to 35% OFF Trending K-Beauty
          </h2>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/products"
            className="hidden sm:inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-xs font-bold text-accent-600 shadow-md hover:bg-white/90 hover:scale-105 transition-all"
          >
            Shop Deals
